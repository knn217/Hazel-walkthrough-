...
namespace Hazel {
	...
	enum class EventType  // Assign each event to a number
	{
		None = 0,
	...
	enum EventCategory  // BIT(x) is defined in Core.h
	{
		None = 0,
...
// This macro is for conveniently override the "get event's type and name" for each event 
